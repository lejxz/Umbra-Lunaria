...
|---|---|---|---|---|---|
| Light poll | every 30 min | POST | `https://<vercel-app>/api/ingest` | `Authorization: Bearer <INGEST_SECRET>` | `{"batch": false}` |
...
| `pollIntervalMinutes` | `30` | Target light-poll cadence; the third-party cron-job service schedule must match it. |
