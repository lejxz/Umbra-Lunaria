...
- [ ] Dashboard summary, donation windows, activity cold-start state, attention queue, clan log, clan profile, and war/capital navigation strips implemented against the shared foundation.
