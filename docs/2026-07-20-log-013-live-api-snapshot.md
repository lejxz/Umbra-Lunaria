...
- Added `docs/api-snapshots/2026-07-20-clan-and-leader-api-response.md` with live values, member list, clan capital details, leader fields, collection counts, and raw-fetch instructions.
...
- The full raw payload remains reproducible through the documented command rather than duplicating every large achievement/unit object inline.
